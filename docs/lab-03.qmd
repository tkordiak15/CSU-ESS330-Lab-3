...
state_per_capita_data <- state_level_data %>% left_join(state_population, by = "state") %>% mutate(new_cases_per_capita = new_cases_lagged / POPESTIMATE2021, rolling_mean_per_capita = rollmean(new_cases_per_capita, k = 7, fill = NA, align = "right", na.rm = TRUE))
```
```{r}
